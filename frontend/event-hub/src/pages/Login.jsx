...
const Login = () => {
    ...
    <div className="login-page">
      <div className="login-left">
        <div className="login-brand">
          <span className="brand-icon"><b>E</b></span>
        ...
        <div className="illustration-wrap">
          ...
          <div className="illustration-wrap">
  <img src={teamIllustration} alt="Team collaboration" className="illustration-svg" />
</div>
        </div>
      </div>
  ...
  <a href="#!" className="forgot-link">Forgot?</a>
          ...
          <p className="login-footer">
            Don't have an account? <a href="#!" className="signup-link">Contact HR</a>
          </p>
        </div>
      </div>
    </div>
